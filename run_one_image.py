...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-dir", type=str, default="data/images/1.png")
    parser.add_argument("--trimap-dir", type=str, default="data/trimaps/1.png")
    parser.add_argument("--output-dir", type=str, default="data/masks/1.png")
